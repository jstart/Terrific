...
- (void)userTouch {
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:@"choice" object:nil userInfo:[NSDictionary dictionaryWithObject:[NSNumber numberWithInt:([(UIButton*)self superview]).tag ] forKey:@"choice"]];
